...
def search_employees_one_row_per_employee_dedup(
    ...
    """
    headers = {'Authorization': f'Bearer DC8qPRNDS_wdY0bmplR_rg'}
...
def main():
    ...
    with tab1:
        ...
        with col1:
            ...
            prov_col1, prov_col2 = st.columns(2)  # New column pair for province
            with prov_col1:
                province = st.text_input("Province", placeholder="e.g. Gauteng")  # New province filter
            with prov_col2:
            ...
            if search_button and search_query:
                with st.spinner("Searching for candidates..."):
                    ...
                    results = run_script(
                        ...
                        province_filter=province if province else None,  # Added province filter
